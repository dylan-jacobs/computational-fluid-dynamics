...
loglog(DTvals, ERRORS2(2, :), '-', 'Color', c_orange, 'LineWidth', 1.5); hold on; % nvals
loglog(DTvals, ERRORS2(3, :), '-', 'Color', c_green,  'LineWidth', 1.5); hold on; % uvals
loglog(DTvals, ERRORS2(4, :), '-', 'Color', c_red,  'LineWidth', 1.5); hold on; % Tvals
