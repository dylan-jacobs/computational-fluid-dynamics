...
u0 = @(x) exp(-600*(x-0.5).^2); % Heaviside step function about x=0.5
...
legend('Gaussian Function around x=0.5', 'Upwind Approximation');
...
legend('Gaussian Function around x=0.5', 'Lax-Wendroff Approximation');
